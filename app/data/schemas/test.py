...
lis = [{'name': {'pt-BR': 'edit', 'default': 'Fool'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Beginnings, Adventure, Possibility'},
                    'down': {'pt-BR': 'edit', 'default': 'Recklessness, Naivety'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Magician'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Capability, Competence, Preparation, Power'},
                    'down': {'pt-BR': 'edit', 'default': 'Manipulation, Lack Of Planning, Untapped Potential'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Priestess'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Intuition, The Subconscious, Mystery'},
                    'down': {'pt-BR': 'edit', 'default': 'Subterfuge, Ignoring Intuition'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Empress'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Growth, Beauty, Abundance'},
                    'down': {'pt-BR': 'edit', 'default': 'Dependence, Repression, Neglect'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit', 'default': '"Headphones on, world off."'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Emperor'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Authority, Structure, Stability'},
                    'down': {'pt-BR': 'edit', 'default': 'Domination, Rigidity'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Hierophant'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Institution, Conformity, Religion'},
                    'down': {'pt-BR': 'edit', 'default': 'Rebellion, Restriction, Censorship'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit', 'default': '"When you forsake the CHURCH you forsake the GODS!"'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Lovers'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Relationships, Love, Choices'},
                    'down': {'pt-BR': 'edit', 'default': 'Disharmony, Uncertainty'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Chariot'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Willpower, Victory, Determination'},
                    'down': {'pt-BR': 'edit', 'default': 'Aggression, Aimlessness'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Strength'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Self-Control, Courage, Compassion'},
                    'down': {'pt-BR': 'edit', 'default': 'Doubt, Lack Of Self-Control, Weakness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Hermit'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Introspection, Knowledge, Contemplation'},
                    'down': {'pt-BR': 'edit', 'default': 'Isolation, Seclusion'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Fortune'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Destiny, Luck, Gratitude'},
                    'down': {'pt-BR': 'edit', 'default': 'Bad Luck, External Influence'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit', 'default': '"Took a bad turn, yeah. But we all do sooner or later."'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Justice'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Fairness, Law, Order, Objectivity'},
                    'down': {'pt-BR': 'edit', 'default': 'Unfairness, Corruption, Dishonesty'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit',
                    'default': '"This unit finds it inconvenient to restrict its own arms of enforcement and as such, it shall operate beyond the scope of your human law. We regret any inconvenience that this social may cause."'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Hanged'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Sacrifice, Release, Acceptance'},
                    'down': {'pt-BR': 'edit', 'default': 'Martyrdom, Indecisiveness, Turmoil'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Death'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Change, Transition, Transformation'},
                    'down': {'pt-BR': 'edit', 'default': 'Resistance, Dwelling, Attachment, Fear'}},
        'text': {'up': {'pt-BR': 'edit', 'default': '"nuthin u cld hve done neway. gg ⦿⽘⦿ c u nxt respawn?"'},
                 'down': {'pt-BR': 'edit', 'default': '"fu u ch347 lol c4n7 u w1n f41rly??? ( ͡° ͜ʖ ͡°)"'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Temperance'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Balance, Calm, Moderation, Wisdom'},
                    'down': {'pt-BR': 'edit', 'default': 'Imbalance, Extremes, Instability'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit', 'default': '"...well this has gone off the rails a bit."'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Devil'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Addiction, Lust, Materialism, Constraints'},
                    'down': {'pt-BR': 'edit', 'default': 'Detachment, Freeing Oneself, Awareness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Tower'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Upheaval, External Change, Realization, Calamity'},
                    'down': {'pt-BR': 'edit', 'default': 'Avoiding External Change, Stress, Overreaction'}},
        'text': {'up': {'pt-BR': 'edit', 'default': '"Ashes, ashes, we all fall down."'},
                 'down': {'pt-BR': 'edit', 'default': '"That\'s impossible!"'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Star'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Hope, Renewal, Belief'},
                    'down': {'pt-BR': 'edit', 'default': 'Despair, Pessimism, Boredom'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Moon'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Illusion, Anxiety, Guidance, Subconscious'},
                    'down': {'pt-BR': 'edit', 'default': 'Confusion, Depression, Danger'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Sun'}, 'keyword': {'up': {'pt-BR': 'edit', 'default': 'Success, Joy'},
                                                                 'down': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Judgement'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Absolution, Rebirth, Decision, Clarity'},
                    'down': {'pt-BR': 'edit', 'default': 'Inability To Examine Oneself, Second Guessing, Stagnation'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'World'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Completion, Attainment, Accomplishment'},
                    'down': {'pt-BR': 'edit', 'default': 'Missing Closure, Incompleteness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ace of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Creation, Beginnings, Potential, Inspiration'},
                    'down': {'pt-BR': 'edit', 'default': 'Lacking Motivation, Unclear Goals, Uncertainty, Delays'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Two of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Progress, Discovery, Planning'},
                    'down': {'pt-BR': 'edit', 'default': 'Lack Of Planning, Complacency, Avoiding Risk, Stagnation'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Three of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Foresight, Preparation, Enterprise'},
                    'down': {'pt-BR': 'edit', 'default': 'Lack Of Foresight, Wasted Efforts, Setbacks'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Four of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Celebration, Community, Home, Harmony'},
                    'down': {'pt-BR': 'edit', 'default': 'Lack Of Harmony, Breakdown In Communication, Uncertainty'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Five of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Competition, Conflict, Strife, Disagreement'},
                    'down': {'pt-BR': 'edit', 'default': 'Repression, Avoiding Conflict, Tension'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Six of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Progress, Victory, Recognition, Confidence'},
                    'down': {'pt-BR': 'edit', 'default': 'Ego, Doubt, Fall From Grace'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Seven of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Competition, Challenge, Perseverance, Success'},
                    'down': {'pt-BR': 'edit', 'default': 'Overwhelming Challenge, Burdened, Giving Up'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Eight of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Speed, Movement, social, Travel, Change'},
                    'down': {'pt-BR': 'edit', 'default': 'Delays, Impatience, Obstacles'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Nine of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Resilience, Courage, Persistence'},
                    'down': {'pt-BR': 'edit', 'default': 'Hesitation, Fear, Avoiding Commitment, Paranoia'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ten of Wires'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Burden, Work, Responsibility'},
                    'down': {'pt-BR': 'edit', 'default': 'Taking On Too Much, Burden, Lacking Responsibility'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Apprentice of Wires(Page of Wands)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Exploration, Enthusiasm, Discovery'},
                    'down': {'pt-BR': 'edit', 'default': 'Setbacks, Pessimism, Defeat, Negativity'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Agent of Wires(Knight of Wands)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Energy, Adventure, Passion, social, Impulsiveness'},
                    'down': {'pt-BR': 'edit', 'default': 'Delays, Frustration, Obstacles'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Supervisor of Wires(Queen of Wands)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Determination, Warmth, Exuberance'},
                    'down': {'pt-BR': 'edit', 'default': 'Selfishness, Manipulation, Demanding, Aggression'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Executive of Wires(King of Wands)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Leadership, Entrepreneur, Vision, Honor'},
                    'down': {'pt-BR': 'edit', 'default': 'Destruction, Ruthlessness, Expectations, Impulsiveness'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ace of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Love, Companionship, Compassion, Joy'},
                    'down': {'pt-BR': 'edit', 'default': 'Isolation, Repressed Emotions, Suppression'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Two of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Partnership, Romance, Respect, Relationships'},
                    'down': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Three of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Celebration, Friendship, Support, Community'},
                    'down': {'pt-BR': 'edit', 'default': 'Suffocation, Lack Of Creativity, Troubled Group Dynamics'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Four of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Apathy, Gratitude, Contemplation, Openness'},
                    'down': {'pt-BR': 'edit', 'default': 'Boredom, Missing Opportunities, Navel-Gazing'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Five of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Loss, Disappointment, Difficulty, Despair'},
                    'down': {'pt-BR': 'edit', 'default': 'Accepting, Forgiving, Moving On, Healing'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Six of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Nostalgia, Childhood, Innocence, The Past'},
                    'down': {'pt-BR': 'edit', 'default': 'Naivety, Dwelling, Stuck In The Past'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Seven of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Illusion, Fantasy, Shallowness, Imagination'},
                    'down': {'pt-BR': 'edit', 'default': 'Temptation, Diversion, Reflection'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Eight of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Disappointment, Re-Evaluation, Escapism, Withdrawal'},
                    'down': {'pt-BR': 'edit', 'default': 'Dissatisfaction, Drifting, Stuck On A Problem'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Nine of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Accomplishment, Satisfaction, Rest, Comfort, Pride'},
                    'down': {'pt-BR': 'edit', 'default': 'Greed, Self-Indulgence, Smugness, Materialism'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ten of Vials'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Happiness, Marriage, Romance, Fulfillment, Harmony'},
                    'down': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Apprentice of Vials(Page of Cups)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Creativity, Synchronicity, Fresh Outlook'},
                    'down': {'pt-BR': 'edit', 'default': 'Immaturity, Frustration, Temper, Sadness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Agent of Vials(Knight of Cups)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Motivation, Imagination, Inspiration'},
                    'down': {'pt-BR': 'edit',
                             'default': 'Moodiness, Overinvested Emotionally, Unrealistic Expectations'}},
        'text': {'up': {'pt-BR': 'edit', 'default': '"Trust your gut, maintain your grip, and move forward. Simple."'},
                 'down': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Supervisor of Vials(Queen of Cups)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Intuition, Compassion, Empathy, Calm'},
                    'down': {'pt-BR': 'edit', 'default': 'Codependency, Disconnection, Insecurity, Escapism'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Executive of Vials(King of Cups)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Emotional Balance, Generosity, Emotional Intellect'},
                    'down': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ace of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Power, Clarity, Victory, Truth'},
                    'down': {'pt-BR': 'edit', 'default': 'Chaos, Confusion, Lacking Clarity'}},
        'text': {'up': {'pt-BR': 'edit', 'default': '"Clear your mind, initiate, take this sword, and strike true."'},
                 'down': {'pt-BR': 'edit',
                          'default': '"Without knowledge one strikes blindly into the dark. Do not flail so, lest you damage what you care about."'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Two of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Indecision, Stalemate, Avoidance'},
                    'down': {'pt-BR': 'edit', 'default': 'Confusion, Overwhelmed, Indecision'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Three of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Heartbreak, Separation, Sorrow, Grief, Betrayal'},
                    'down': {'pt-BR': 'edit', 'default': 'Forgiveness, Letting Go, Healing, Resolution'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Four of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Solitude, Contemplation, Recovery, Rest'},
                    'down': {'pt-BR': 'edit', 'default': 'Burn-Out, Stagnation, Stress, Restlessness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Five of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Conflict, Loss, Hostility, Defeat'},
                    'down': {'pt-BR': 'edit', 'default': 'Resentment, Pride, Malice, Meaningless Victory'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Six of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Transition, Recovery, Travel, Refuge'},
                    'down': {'pt-BR': 'edit', 'default': 'Baggage, Stasis, Dwelling'}}, 'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Seven of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Deception, Secrecy, Strategy'},
                    'down': {'pt-BR': 'edit', 'default': 'Breaking Habits, Lack Of Initiative, Honesty, Uncertainty'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Eight of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Imprisonment, Powerlessness, Blind Spots, Isolation'},
                    'down': {'pt-BR': 'edit', 'default': 'Freedom, Clarity, Agency, Self-Acceptance'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Nine of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Nightmares, Anxiety, Depression, Torment, Worry'},
                    'down': {'pt-BR': 'edit', 'default': 'Perspective, Recovery, Hopelessness'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ten of Arms'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Betrayal, Loss, Suffering, Endings'},
                    'down': {'pt-BR': 'edit', 'default': 'Release, Beginnings, Rebirth, Survival, Rescue'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Apprentice of Arms(Page of Swords)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Energetic, Curiosity, Restless, social'},
                    'down': {'pt-BR': 'edit', 'default': 'Inaction, Haste, Lack Of Follow-Through'}}, 'text': {
           'up': {'pt-BR': 'edit', 'default': '"I know what to do, I know how to do it, just let me do it already!"'},
           'down': {'pt-BR': 'edit',
                    'default': '"I asked them to let me do my thing and now that I\'m in the spotlight I somehow... I don\'t know what to do?"'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Agent of Arms(Knight of Swords)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Directness, social, Authority, Hasty'},
                    'down': {'pt-BR': 'edit', 'default': 'Reckless, Impulsive, Thoughtless'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Supervisor of Arms(Queen of Swords)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Intellect, Perceptive, Independent, Maturity'},
                    'down': {'pt-BR': 'edit', 'default': 'Emotional, Detached, Bitter, Cold'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Executive of Arms(King of Swords)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Intellect, Authority, Truth, Ethics'},
                    'down': {'pt-BR': 'edit', 'default': 'Manipulation, Abuse, Control, Tyranny'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ace of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Bounty, Prosperity, Financial Opportunity, Windfall'},
                    'down': {'pt-BR': 'edit', 'default': 'Lack Of Planning, Uncertainty, Lofty Goals'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Two of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Balance, Distractions, Adaptability, Juggling'},
                    'down': {'pt-BR': 'edit', 'default': 'Chaos, Disorganization, Overwhelming Stress'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Three of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Mentorship, Learning, Teamwork, Collaboration'},
                    'down': {'pt-BR': 'edit', 'default': 'Misinformation, Disregard Of Skills, Secrets'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Four of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Hoarding, Control, Stability, Conservatism'},
                    'down': {'pt-BR': 'edit', 'default': 'Greed, Materialism, Ulterior Motives'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Five of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Poverty, Isolation, Aid, Generosity, Insecurity'},
                    'down': {'pt-BR': 'edit', 'default': 'Frigidity, Lack Of Charity, Spiritual Poverty'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Six of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Generosity, Recovery, Refuge, Sharing'},
                    'down': {'pt-BR': 'edit', 'default': 'Selfishness, Debt, Poor Investments, Inequality'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Seven of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Reward, Investment, Profit, Simple Pleasure'},
                    'down': {'pt-BR': 'edit', 'default': 'Lacking Reward, Financial Failure, Losing Comforts'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Eight of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Diligence, Labor, Education, Investment'},
                    'down': {'pt-BR': 'edit', 'default': 'Perfectionism, Wasted Energy, Mistakes, Creative Apathy'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Nine of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Success, Introspection, Luxury, Self-Sufficiency'},
                    'down': {'pt-BR': 'edit', 'default': 'Miscalculation, Work Imbalance, Financial Setbacks'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Ten of Zent'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Providing, Wealth, Family, Leadership'},
                    'down': {'pt-BR': 'edit', 'default': 'Loneliness, Dwelling, Loss'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Apprentice of Zent(Page of Pentacles)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Opportunity, New Work, Spiritual Bounty'},
                    'down': {'pt-BR': 'edit', 'default': 'Disconnect From Inner Self, Short-Term Focus, Setbacks'}},
        'text': {'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Agent of Zent(Knight of Pentacles)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Determination, Efficiency, Routine, Work'},
                    'down': {'pt-BR': 'edit', 'default': 'Laziness, Apathy, Giving Up, Disorientation'}}, 'text': {
           'up': {'pt-BR': 'edit',
           ...
           'down': {'pt-BR': 'edit', 'default': '"Another day and more of the same. Who cares?"'}}},
       {'name': {'pt-BR': 'edit', 'default': 'Supervisor of Zent(Queen of Pentacles)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Practicality, Nourishment, Safety, Protection'},
                    'down': {'pt-BR': 'edit', 'default': 'Resentment, Abandonment, Disconnect In Family'}}, 'text': {
           'up': {'pt-BR': 'edit',
       ...
       {'name': {'pt-BR': 'edit', 'default': 'Executive of Zent(King of Pentacles)'},
        'keyword': {'up': {'pt-BR': 'edit', 'default': 'Abundance, Security, Control, Avarice'},
                    'down': {'pt-BR': 'edit', 'default': 'Selfishness, Pretense, Domineering, Greed'}}, 'text': {
           'up': {'pt-BR': 'edit',
...
where = ["app", "languages", "description.json"]
command = ["deck", "response"]
slash = json_text(where=where, commands=command)

for url in slash.deck:
    name = str(slash.deck[url]).split("/")[6].replace("_", " ").replace(".png", "")
    slash.response[str(url)]["url"] = slash.deck[url]
    slash.response[str(url)]["name"]["default"] = name


print(json.dumps(slash.response, indent=2))